...
class DTU10MWCTTabularSurrogate():
    ...
    ct_array = np.array([[0.  , 0.  , 0.  , 0.  , 0.  , 0.  ],
                        ...
                        [0.27, 0.42, 0.62, 0.83, 0.82, 0.82],
                        [0.37, 0.62, 0.83, 0.84, 0.83, 0.82],
                        [0.56, 0.83, 0.84, 0.84, 0.83, 0.82],
                        [0.83, 0.84, 0.84, 0.84, 0.83, 0.82],
    ...
    power_array = np.array([[    0.  ,     0.  ,     0.  ,     0.  ,     0.  ,     0.  ],
                            ...
                            [ 3999.95,  5993.36,  6680.62,  6680.94,  6692.95,  6701.88],
                            [ 3999.95,  5999.93,  7993.81,  8933.94,  8950.45,  8962.82],
                            [ 3999.95,  5999.95,  7999.96,  9996.91, 10493.57, 10988.26],
                            [ 3999.95,  5999.96,  7999.96,  9999.63, 10499.95, 10999.9 ],
                            [ 3999.96,  5999.96,  7999.96,  9999.64, 10499.96, 10999.92],
                            [ 3999.96,  5999.97,  7999.97,  9999.64, 10499.98, 10999.97],
                            [ 3999.96,  5999.97,  7999.97,  9999.66, 10499.98, 10999.98],
                            [ 3999.97,  5999.98,  7999.97,  9999.69, 10499.99, 10999.98],
                            [ 3999.97,  5999.98,  7999.97,  9999.71, 10500.02, 11000.  ],
                            [ 3999.98,  5999.98,  7999.97,  9999.71, 10500.04, 11000.01],
                            [ 3999.98,  5999.98,  7999.97,  9999.75, 10500.1 , 11000.18],
                            [ 3999.98,  5999.98,  7999.98,  9999.78, 10500.28, 11000.18],
                            [ 3999.99,  5999.98,  7999.98,  9999.81, 10500.33, 11000.31],
                            [ 4000.01,  5999.99,  7999.98,  9999.84, 10500.47, 11000.49],
                            [ 4000.01,  5999.99,  7999.98,  9999.88, 10500.59, 11000.51],
                            [ 4000.01,  5999.99,  7999.98,  9999.88, 10500.59, 11000.51]])
    
    powerCtFunction = PowerCtNDTabular(input_keys=['ws','psp'],
                     value_lst=[ws_lst, psp_lst],
                     power_arr=power_array, power_unit='kW', # doesnt matter (power output --> surrogate)
                     ct_arr=ct_array)
...
class DTU10MWSurrogateWindTurbine(WindTurbine):
    ...
    def __init__(self):
        ...
        powerCtFunction = PowerSurrogate(TensorflowSurrogate_DTU10MW(aersur_path + "Power_Q50_model", "Power"), 'kW',
