...
setup(name='py_wake',
      ...
      packages=find_packages(),
          ...
          'py_wake': ['examples/data/iea37/*.yaml',
                      ...
                      'examples\data\surrogates\Blade_root_edgewise_M_y/*.h5',
                      'examples\data\surrogates\Blade_root_flapwise_M_x/*.h5',
                      'examples\data\surrogates\Power/*.h5',
                      'examples\data\surrogates\Tower_top_tilt_M_x/*.h5',
                      'examples\data\surrogates\Tower_top_yaw_M_z/*.h5',
                      'examples\data\surrogates\Blade_root_edgewise_M_y/*.plk',
                      'examples\data\surrogates\Blade_root_flapwise_M_x/*.plk',
                      'examples\data\surrogates\Power/*.plk',
                      'examples\data\surrogates\Tower_top_tilt_M_x/*.plk',
                      'examples\data\surrogates\Tower_top_yaw_M_z/*.plk',
                      ],
      },
      install_requires=[
